...
本应用为开源应用，提供的功能和服务安全性需使用者自行审查。因使用本应用而产生的任何数据丢失、设备异常、隐私泄露或其他直接或间接的损失，均与开发者或小米公司无关。开发者及小米公司不对本应用的功能性、安全性及合法性承担任何形式的保证或赔偿责任。若在使用中遇到故障或缺陷，请在本项目的 Issue 页进行反馈。
